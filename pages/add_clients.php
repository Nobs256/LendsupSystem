...
xmlhttp.open("GET","user_connector.php?add_clients=1&boss_id="+boss_id+"&user_id="+user_id+"&fname="+fname+"&lname="+lname+"&sex="+sex+"&phone="+phone+"&place_r="+place_r+"&business="+business+"&b_location="+b_location,true);
xmlhttp.send();
}
}
