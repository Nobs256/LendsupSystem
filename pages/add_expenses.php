...
var nara=document.getElementById("nara").value;
if(b_date.length>0 && amo.length>=3 && nara.length>=3)
{
...
xmlhttp.open("GET","user_connector.php?exp=1&boss_id="+boss_id+"&user_id="+user_id+"+&b_date="+b_date+"&item="+item+"&nara="+nara+"&amo="+amo,true);
xmlhttp.send();
}
}
...
<div id="main_heading"> <b>Enter Expenses</b>
...
<select  id="item"  style="width:230px; border: 1px solid #006F37" required>
<option></option>
<?php
$comb = mysqli_query($conn,"SELECT * from expenses_list order by item ");
while($select_comb = mysqli_fetch_array($comb)){
$item=$select_comb['item'];
...
<td width="190px">
<input type="text" id="nara" class="input is-success" style="width:230px; border: 1px solid #006F37" 
required><br><br>
</td>
<tr>
<td width="100px"> 
...
<td width="190px">
<input type="date" id="b_date" class="input is-success" style="width:230px; border: 1px solid #006F37" 
required><br><br>
</td>
</tr>
<tr>
