...
<a href='add_location.php?reload=1' style='color:white; margin-left:350px;''>X</a>
</div>";
...
<option></option>
<?php
$comb = mysqli_query($conn,"SELECT * from new_users where boss_id='$boss_id' and active=1 and user_id='$user_id' and category='User'");
...
<td>$location</td>
<td>$branch</td>
<td><a   href='add_location.php?delete_location=$location_id;'><font color=red>&nbsp;DELETE</font></a></td>";
}
