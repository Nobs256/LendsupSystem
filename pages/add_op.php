...
xmlhttp.open("GET","user_connector.php?op=1&boss_id="+boss_id+"&user_id="+user_id+"+&b_date="+b_date+"&amo="+amo,true);
xmlhttp.send();
}
}
...
<div id="main_heading"> <b>Enter Openning Stock</b>
<font color="#EAEAEA">-------------------</font>
<a href="#"><font color="green">View Opening Stock</font></a> 
</div>     
<br>
