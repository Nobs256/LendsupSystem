             ...
             if(isset($_REQUEST['sc_id'])){
                 $sc_id=$_REQUEST['sc_id'];
                        $search_query= mysqli_query($conn,"SELECT sc_id, ucase(sc_name) as sc_name, ucase(hm_name) as hm_name, hm_phone 
                          FROM schools where  sc_id=' $sc_id'");
                        ?>               
 ...
 <ul>
                            ...
                            <div class="dropdown-menu dropdown-menu-right"  
                             aria-labelledby="navbarDropdownMenuLink1">
                                ...
                                <a class="dropdown-item" href="items_given_user_form.php?sc_id=<?php echo $sc_id?>">
                                  <i class="fas fa-user mr-2"></i>Ibikoresho</a>
                                <a class="dropdown-item" href="services_given_user.php?sc_id=<?php echo $sc_id?>">
                                <i class="fas fa-user mr-2"></i>Services</a>
