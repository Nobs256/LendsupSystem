...
?>
<div id="main_heading"> 
<table><tr><td><b>Bank Deposits</b> </td><td>
...
$search_query= mysqli_query($conn,"SELECT * FROM banking where userde_id='$user_id'
 and bossde_id='$boss_id' and MONTH(de_date)='$month' and transc='Deposit' and bank_name='Centenary' order by de_date");
...
//==Equity
$search_query= mysqli_query($conn,"SELECT * FROM banking where userde_id='$user_id'
 and bossde_id='$boss_id' and MONTH(de_date)='$month' and transc='Deposit' and bank_name='Equity' order by de_date");
 while($returned_result = mysqli_fetch_assoc($search_query)){
$amount  = $returned_result["de_amount"]; 
...
$j=0;
echo "<b>Bank Deposits in $mon</b><br><br> ";
...
<tbody>";
$search_query= mysqli_query($conn,"SELECT * FROM banking where userde_id='$user_id'
 and bossde_id='$boss_id' and MONTH(de_date)='$month' and transc='Deposit' order by bank_name");
 while($returned_result = mysqli_fetch_assoc($search_query)){
$j++;
