...
$amount_paid1= $result['amount_paid'];
$total_amount_paid+=$amount_paid1;
}
}
echo " <p align=center><font size=4><b>$branch BRANCH ($location Field)</b><br>
Number of Clients Paid on <b> $d </b>is <b>$j</b></font><br>
Total Amount Paid:<b>".number_format($total_amount_paid)."<br>";
