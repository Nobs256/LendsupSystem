...
$search_query= mysqli_query($conn,"SELECT client_id, ucase(firstname) as firstname, ucase(lastname) as lastname, phone, take_date 
FROM clients, idTake  where users_id='$user_id' and bosses_id='$boss_id' and client_id=clientde_id and take=1");
