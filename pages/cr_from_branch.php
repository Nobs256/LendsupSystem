...
xmlhttp.open("GET","user_connector.php?money_sent=1&boss_id="+boss_id+"&branch="+branch+"&user_id="+user_id+"+&b_date="+b_date+"&amo="+amo,true);
xmlhttp.send();
}
}
...
<div id="main_heading">  <b>Recievables</b> (Money Sent to Another Branch)
