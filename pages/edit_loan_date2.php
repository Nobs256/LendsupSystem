...
$amount_given  = number_format($result["amount_given"]);
}
?>
...
xmlhttp.open("GET","user_connector.php?update_loan_date=1&boss_id="+boss_id+"&user_id="+user_id+"&client_id="+client_id+"&b_date="+b_date+"&loan_no="+loan_no+"&date1="+date1,true);
xmlhttp.send();
}
}
...
CHANGE LOAN DATE GIVEN:</b> <?php echo "$name ($phone) Took <u>$amount_given</u> on <b>$pay_date</b>";  
...
<input type="hidden" id="date1" value="<?php echo $date; ?>">
