...
xmlhttp.open("GET","admin_connector.php?update_loan=1&boss_id="+boss_id+"&client_id="+client_id+"&b_date1="+b_date1+"&b_date="+b_date+"&amo="+amo+"&reg_fee="+reg_fee,true);
xmlhttp.send();
}
}
...
<td> $reg_fee</td> 
<td> $amount_given </td> 
<td> <a href='error_give_loan.php?client_id=$clients_id&give=$loan_id'>Update</td>
<td> <a href='error_give_loan.php?client_id=$clients_id&delete=$loan_id'><font color=red>Delete</font></td>
";
echo "</tr>";
}
echo "</tbody></table>";
...
where clientsid='$client_id' and bosseseid='$boss_id' and pay_date='$p_date' "));     
...
<a href='search_client_errors.php?reload=1' style='color:white; margin-left:50px;''>X</a></div>";
}

else if($p_date!=$curr_date && $p_date!=$pre_date){
echo"<div style='background-color:red; border-radius:5px; color:white; 
...
<a href='admin_homepage.php?client_id=$client_id' style='color:white; margin-left:100px;''>Back</a></div>";
