...
var save_date=document.getElementById("save_date").value;
var amo=document.getElementById("uamo").value;
if(save_date.length>0 && amo.length>=3)
{
...
xmlhttp.open("GET","user_connector.php?savings=1&boss_id="+boss_id+"&user_id="+user_id+"&client_id="+client_id+"&save_date="+save_date+"&amo="+amo,true);
xmlhttp.send();
}
}
...
SAVING FOR:</b> <?php echo "$name ($phone)"; ?>  
...
<td width="210px">
<input type="date" id="save_date" class="input is-success" style="width:190px; border: 1px solid #006F37" 
required><br><br>
</td>
<td width="100px"> 
Amount:
