...
$result = mysqli_fetch_assoc(mysqli_query($conn,"select * from clients_with_loan_def 
...
xmlhttp.open("GET","pay_loan_connector_def.php?ref=1&boss_id="+boss_id+"&user_id="+user_id+"&client_id="+client_id+"&b_date="+b_date+"&loan_no="+loan_no+"&amo="+amo,true);
xmlhttp.send();
}
}
