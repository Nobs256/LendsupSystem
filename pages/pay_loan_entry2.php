...
xmlhttp.open("GET","pay_loan_connector_entry2.php?ref=1&boss_id="+boss_id+"&user_id="+user_id+"&client_id="+client_id+"&b_date="+b_date+"&loan_no="+loan_no+"&amo="+amo,true);
xmlhttp.send();
}
}
...
<input type="hidden" id="b_date" value="<?php echo $b_date; ?>">
<tr>
<td width="100px"> 
Balance:
</td>
