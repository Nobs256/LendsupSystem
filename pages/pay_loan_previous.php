...
xmlhttp.open("GET","pay_loan_connector.php?ref=1&boss_id="+boss_id+"&user_id="+user_id+"&client_id="+client_id+"&b_date="+b_date+"&loan_no="+loan_no+"&amo="+amo,true);
xmlhttp.send();
}
}
...
LOAN PAYMENT:</b> <?php echo "$name ($phone)";  
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href='pay_loan.php?client_id=$client_id'>
<font color=green size=4><b>Make Daily Payment</b></font></a>";
?>  
 </div>  
<br>
</div> 
