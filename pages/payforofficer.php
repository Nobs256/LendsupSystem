...
$report=1;
echo"<div style='background-color:red; border-radius:5px; color:white; 
height:40px; margin-left:25px; padding:7px; width: 700px'>You Have Selected wrong date
<a href='user_homepage.php' style='color:white; margin-left:70px;''>X</a></div>";
}
...
$off_name = $returned_result["firstname"]. " ". $returned_result["lastname"];
...
<td width=60%>
<p align=left><b>You are Paying for $off_name  - ($location) on <u> $payingdate</u></b></td>
...
<td>
<a href='pay_for_officers.php?reload=1' style='color:white; margin-left:100px;''>$pay_date</a>
</td></tr></table>
