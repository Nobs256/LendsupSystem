...
<td width=40%>
Loan Aging Analysis Statement for <br><b>$name  $branch  Branch ($location)</b><br><br></td>";
...
VALUES (NULL, '$user_id', '$boss_id', '$client_id', '$curr_date', '$name',  '$phone', '$date_given', '$end_date', '$amount_given', '$interest', '$debt', '$missed_balance', 
'$x',  '$loanNo', '$phoneg', '$gname')");
}
