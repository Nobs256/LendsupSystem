...
--
-- Host: localhost
-- Generation Time: Aug 26, 2026 at 09:23 AM
...
--
-- Table structure for table `clients_def`
--

CREATE TABLE `clients_def` (
...
--
-- Table structure for table `clients_with_loan_def`
--

CREATE TABLE `clients_with_loan_def` (
  `loan_id` bigint(22) NOT NULL,
  `loan_no` bigint(22) NOT NULL,
  `clientsid` bigint(22) NOT NULL,
  `userseid` bigint(22) NOT NULL,
...
--
-- Table structure for table `completed_loan_def`
--

CREATE TABLE `completed_loan_def` (
  `loan_id` bigint(22) NOT NULL,
  `loans_no` bigint(22) NOT NULL,
  `clientcpid` bigint(22) NOT NULL,
  `userscpid` bigint(22) NOT NULL,
...
CREATE TABLE `field_payment` (
  ...
  `amount` bigint(10) NOT NULL,
  `mom` bigint(4) NOT NULL,
  `pyt_method` varchar(10) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
--
-- Table structure for table `loans_def`
--

CREATE TABLE `loans_def` (
  `loan_id` bigint(22) NOT NULL,
  `cliente_id` bigint(22) NOT NULL,
  `userse_id` bigint(22) NOT NULL,
  `bossese_id` bigint(22) NOT NULL,
...
CREATE TABLE `loan_pay` (
  ...
  `balance` bigint(22) NOT NULL,
  `mom` bigint(4) NOT NULL,
  `intrest_paid` varchar(10) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- --------------------------------------------------------

--
-- Table structure for table `loan_pay_advance`
--

CREATE TABLE `loan_pay_advance` (
  `loan_id` bigint(22) NOT NULL,
  `loanNo` bigint(22) NOT NULL,
  `clients_id` bigint(22) NOT NULL,
  `userse_id` bigint(22) NOT NULL,
...
CREATE TABLE `loan_pay_daily` (
  ...
  `balance` bigint(22) NOT NULL,
  `mom` bigint(4) NOT NULL,
  `intrest_paid` varchar(22) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
--
-- Indexes for table `clients_def`
--
ALTER TABLE `clients_def`
  ADD PRIMARY KEY (`clientf_id`);
...
--
-- Indexes for table `clients_with_loan_def`
--
ALTER TABLE `clients_with_loan_def`
  ADD PRIMARY KEY (`loan_id`);
...
--
-- Indexes for table `completed_loan_def`
--
ALTER TABLE `completed_loan_def`
  ADD PRIMARY KEY (`loan_id`);
...
--
-- Indexes for table `deleted_clients`
--
ALTER TABLE `deleted_clients`
  ADD PRIMARY KEY (`loan_id`);
...
--
-- Indexes for table `loans_def`
--
ALTER TABLE `loans_def`
  ADD PRIMARY KEY (`loan_id`);
...
--
-- Indexes for table `loan_pay_advance`
--
ALTER TABLE `loan_pay_advance`
  ADD PRIMARY KEY (`loan_id`);
...
--
-- AUTO_INCREMENT for table `clients_def`
--
ALTER TABLE `clients_def`
  MODIFY `clientf_id` bigint(22) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `clients_with_loan_def`
--
ALTER TABLE `clients_with_loan_def`
  MODIFY `loan_id` bigint(22) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `completed_loan_def`
--
ALTER TABLE `completed_loan_def`
  MODIFY `loan_id` bigint(22) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `deleted_clients`
--
ALTER TABLE `deleted_clients`
  MODIFY `loan_id` bigint(22) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `loans_def`
--
ALTER TABLE `loans_def`
  MODIFY `loan_id` bigint(22) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `loan_pay_advance`
--
ALTER TABLE `loan_pay_advance`
  MODIFY `loan_id` bigint(22) NOT NULL AUTO_INCREMENT;
