...
--
-- Host: localhost
-- Generation Time: Aug 28, 2026 at 05:33 AM
...
--
-- Table structure for table `changed_balance`
--

CREATE TABLE `changed_balance` (
  `loan_id` bigint(22) NOT NULL,
  `clientb_id` bigint(22) NOT NULL,
  `userse_id` bigint(22) NOT NULL,
  `bossese_id` bigint(22) NOT NULL,
  `p_date` date NOT NULL,
  `pre_balance` bigint(22) NOT NULL,
...
CREATE TABLE `cleared_loans` (
  `cleared_id` bigint(22) NOT NULL,
  `users_id` bigint(22) NOT NULL,
  `bosses_id` bigint(22) NOT NULL,
  `clientcl_id` bigint(22) NOT NULL,
  `date` date NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `clients_not_paid` (
  ...
  `arears` decimal(10,2) DEFAULT NULL,
...
--
-- Table structure for table `daily_loans`
--

CREATE TABLE `daily_loans` (
  `loan_id` bigint(22) NOT NULL,
...
--
-- Table structure for table `daily_pay`
--
...
--
-- Table structure for table `delete_previous_payment`
--

CREATE TABLE `delete_previous_payment` (
  `ts_id` bigint(22) NOT NULL,
  `client_id` bigint(22) NOT NULL,
  `user_id` bigint(22) NOT NULL,
  `boss_id` bigint(22) NOT NULL,
  `numb` bigint(3) NOT NULL,
  `date_paid` date NOT NULL,
  `amount` bigint(5) NOT NULL,
  `balance` bigint(5) NOT NULL,
...
--
-- Table structure for table `loan_pay_temp`
--

CREATE TABLE `loan_pay_temp` (
  `loan_id` bigint(22) NOT NULL,
  `loanNo` bigint(22) NOT NULL,
  `clients_id` bigint(22) NOT NULL,
  `userse_id` bigint(22) NOT NULL,
...
CREATE TABLE `membership` (
  `membership_id` bigint(22) NOT NULL,
  `user_id` bigint(22) NOT NULL,
  `boss_id` bigint(22) NOT NULL,
  `clients_id` bigint(22) NOT NULL,
  `amount` bigint(10) NOT NULL,
...
--
-- Table structure for table `process_fees`
--

CREATE TABLE `process_fees` (
  `fee_id` bigint(22) NOT NULL,
  `clientfee_id` bigint(22) NOT NULL,
  `usersfee_id` bigint(22) NOT NULL,
  `bossesfee_id` bigint(22) NOT NULL,
...
--
-- Table structure for table `weekly_clients`
--

CREATE TABLE `weekly_clients` (
  `loan_id` bigint(22) NOT NULL,
  `clientw_id` bigint(22) NOT NULL,
  `usersw_id` bigint(22) NOT NULL,
  `bossesw_id` bigint(22) NOT NULL,
  `location` varchar(20) NOT NULL,
  `loan_type` varchar(22) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
--
-- Indexes for table `changed_balance`
--
ALTER TABLE `changed_balance`
...
--
-- Indexes for table `daily_loans`
--
ALTER TABLE `daily_loans`
  ADD PRIMARY KEY (`loan_id`);

--
-- Indexes for table `daily_pay`
--
ALTER TABLE `daily_pay`
  ADD PRIMARY KEY (`loan_id`);
...
--
-- Indexes for table `delete_previous_payment`
--
ALTER TABLE `delete_previous_payment`
  ADD PRIMARY KEY (`ts_id`);
...
--
-- Indexes for table `loan_pay_temp`
--
ALTER TABLE `loan_pay_temp`
  ADD PRIMARY KEY (`loan_id`);
...
--
-- Indexes for table `process_fees`
--
ALTER TABLE `process_fees`
...
--
-- Indexes for table `weekly_clients`
--
ALTER TABLE `weekly_clients`
  ADD PRIMARY KEY (`loan_id`);
...
--
-- AUTO_INCREMENT for table `changed_balance`
--
ALTER TABLE `changed_balance`
...
--
-- AUTO_INCREMENT for table `delete_previous_payment`
--
ALTER TABLE `delete_previous_payment`
  MODIFY `ts_id` bigint(22) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `loan_pay_temp`
--
ALTER TABLE `loan_pay_temp`
  MODIFY `loan_id` bigint(22) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `membership`
  MODIFY `membership_id` bigint(22) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `process_fees`
--
ALTER TABLE `process_fees`
  MODIFY `fee_id` bigint(22) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `shares`
  MODIFY `share_id` bigint(22) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `weekly_clients`
--
ALTER TABLE `weekly_clients`
  MODIFY `loan_id` bigint(22) NOT NULL AUTO_INCREMENT;
