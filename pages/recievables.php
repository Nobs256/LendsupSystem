...
?>
<div id="main_heading"> 
<table><tr><td><b>Recivables(Money Sent to Another Branch)</b> </td><td>
...
echo "<br><br>";
$j=0;
echo "<b>Recievables  in $mon</b><br><br> ";
...
<tbody>";
$search_query= mysqli_query($conn,"SELECT * FROM sent_to_branch where usercr_id='$user_id' and bosscr_id='$boss_id' and MONTH(cr_date)='$month' order by cr_date");
