...
where clientsave_id='$client_id' and user_id='$user_id' and  boss_id='$boss_id' 
and save_date='$date1'"));     
$datee = $result['save_date'];
$save_id = $result['save_id'];


if($datee!=$date1){
echo "<p align=center><font size=5 color=red><br><br><br><br><br>Error!!!!
You select one of the dates a client did not save</font></p>";
}
else{
...
echo "<p align='left'><font size='3'>  *** SAVING HISTORY *** <br>=========================== </font> 
  
 
<table align='left' border='0' width='50%' style='font-size:13px'>
<tr><td>
<p align='left'>
Batch Number: <u>BTN $save_id</u><br>
...
$result = mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM savings where 
clientsave_id='$client_id' and user_id='$user_id' and boss_id='$boss_id'  and save_date='$date1'")); 
