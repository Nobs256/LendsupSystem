...
mysqli_query($conn,"INSERT INTO demand(demand_id, clientde_id, userde_id, bossde_id, amount, demand_date) 
VALUES (NULL, '$client_id', '$user_id', '$boss_id', '$amount', '$date')");
...
<a href='search_client_demand.php' style='color:white; margin-left:100px;''>X</a>
</div>"; 
...
<div id="main_heading"> <b>Search a Client to Make Demand for Tomorrow</b>
</div>     
...
$debt = number_format($results["debt"]);
 ...
 $allowed="<a href='search_client_demand.php?client_id=$client_id'><font size=4 color=green><b>Select</b></font></a>";
 $debt=0;
 }
