...
mysqli_query($conn,"INSERT INTO idTake(idTake_id, clientde_id, userde_id, bossde_id, take_date, return_date, take) 
VALUES (NULL, '$client_id', '$user_id', '$boss_id', '$date', '$date', '$take')");

mysqli_query($conn,"INSERT INTO idTake_history(idTake_id, clientde_id, userde_id, bossde_id, take_date, return_date) 
VALUES (NULL, '$client_id', '$user_id', '$boss_id', '$date', '$date')");
...
<div id="main_heading"> <b>Search a Client to Take ID</b>
</div>     
...
where clientde_id='$client_id' and userde_id='$user_id' and bossde_id='$boss_id' and take=1")); 
 ...
 if($take>=1){
 $allowed="<a href='#'><font color=red><b>Already Taken</b></font></a>";
 }
 else{
 $allowed="<a href='search_client_take_id.php?client_id=$client_id'><font size=4 color=green><b>GIVE ID</b></font></a>";
 $take=0;
 }
echo "<tr>
