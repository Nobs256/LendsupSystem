...
$heading="LOAN PAYMENT USING UNKNOWN <br>Search a Client to Pay Loan</b>";
}
...
<input type="hidden" name="unknown_id" value="<?php echo $unknown_id; ?>" >
...
<td><a href='pay_loan_using_unknown.php?client_id=$client_id&unknown_id=$unknown_id'>Pay Loan</a>
</td>";
}
