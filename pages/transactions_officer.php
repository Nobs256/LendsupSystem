...
Loan Given: ". number_format($total_given_loan)."&nbsp;&nbsp;&nbsp;
Processing.Fee: ".number_format($total_reg_fee)."&nbsp;&nbsp;&nbsp;
</td>
<td width=5%>
...
Total Amount Paid: ".number_format($total_amount_cash+$total_amount_mom)."&nbsp;&nbsp;
Banking: ".number_format($total_bank_deposit)."&nbsp;&nbsp; 
Cash Recieved: ".number_format($total_bank_withdraw)."&nbsp;&nbsp;&nbsp;
Expenses: ".number_format($total_exp)."&nbsp;&nbsp;

<br>
<p align=center><b>
Cash In: ".number_format($total_amount_cash+$total_reg_fee)."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Cash Out: ".number_format($total_given_loan)."&nbsp;&nbsp;&nbsp;</b>"
.$display_excess."&nbsp;&nbsp;&nbsp;&nbsp;"
.$display_unknown_cash."&nbsp;&nbsp;&nbsp;&nbsp;"
.$display_withdraw_unknown_cash."&nbsp;&nbsp;&nbsp;&nbsp;
</p>
...
$closing=0;
$closing=$total_op;
$search_query= mysqli_query($conn,"SELECT * FROM transcations where user_id='$user_id' and boss_id='$boss_id' and transc_date='$d' order by ts_id");
...
<td>".strtoupper($transc_name)."</td>
<td></td>
<td><b>".number_format($transc_amount)." Withdraw </b></td>
<td>".number_format($closing)."</td>
";
echo "</tr>";
}
//Savings
if($transc_type=='Cash_in' && $mom==4){
$closing+=$transc_amount;
echo"
<td> $j </font></td>
<td>".strtoupper($transc_name)."</td>
<td><b>".number_format($transc_amount)." SAVINGS </b></td>
<td> </td> 
<td>".number_format($closing)."</td>
";
echo "</tr>";
...
$recovered_shortage+$total_excess+$cash_from_branch+$total_bank_withdraw+$mom_balance;

$tco=$trash+$total_given_loan+$total_exp+$total_bank_deposit+$withdraw_defaulters+$cash_to_branch+$total_withdraws-$total_withdraw_unknown_cash; 	 
...
Cash_out: ".number_format($tco)."</td><td><b>Closing Stock:  ".number_format($cs)."</b></td></tr>";
echo "</tbody></table><br> ";
