...
<a style="border: 1px solid #006F37; border-radius:4px; font-size:14px; color:#006F37; height:30px; margin-left:700px; background-color:#006F37; color:white"
 class="button is-default" href="user_homepage_def.php">
&nbsp;Pay For Defaulters&nbsp;</a>
...
clients_with_loan.amount_given, clients_with_loan.daily_p, clients_with_loan.debt,
clients_with_loan.interest, clients_with_loan.days
FROM clients
INNER JOIN clients_with_loan ON clients.client_id=clients_with_loan.clientsid
WHERE clients.users_id='$user_id' AND clients.bosses_id='$boss_id'
AND clients_with_loan.userseid='$user_id' AND clients_with_loan.bosseseid='$boss_id'
AND clients_with_loan.debt>0 ORDER BY clients.firstname");
?>  
...
class="button is-default" href="pay_loan.php?client_id=<?php echo $client_id;?>">&nbsp;
Pay Loan&nbsp;</a>
</td>
<td>
