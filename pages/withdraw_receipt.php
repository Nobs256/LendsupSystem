...
where clientwith_id='$client_id' and user_id='$user_id' and  boss_id='$boss_id' and with_date='$payed_date'"));     
$receipt = $result['with_id'];
$amount_paid =number_format($result['amount']);
$p_date = $result['with_date'];
...
echo"<br>";
echo "<p align='left'><font size='3'>  *** Withdraw Receipt *** <br>==================</font>   
...
Customer:<u>$c_name<br>
     ...
     *****Payment Details**** <br>
=======================<br>
Amount withdrawn: <u><b>UGX $amount_paid/=</b></u><br>
Withdraw Date: <u><b>$date_paid</b></u><br>
Remaining Balance: <u><b>UGX $total</b></u><br>
<br> 
=======================<br>
