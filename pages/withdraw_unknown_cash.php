...
xmlhttp.open("GET","user_connector.php?withdraw_unknown_cash=1&boss_id="+boss_id+"&user_id="+user_id+"+&b_date="+b_date+"+&officer_id="+officer_id+"&amo="+amo,true);
xmlhttp.send();
}
}
...
<div id="main_heading"> <b>Withdraw Unknown Cash</b>
