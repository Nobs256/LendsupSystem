...
<a href='withdraws.php' style='color:white; margin-left:100px;''>X</a>
</div>";
}
...
<a href='withdraws.php' style='color:white; margin-left:90px;''>X</a></div>";
}
?>
 <style>
 tr:nth-child(even) {
...
if(with_date.length>0 && amo.length>=3 && withdraw.length>=3)
{
...
xmlhttp.open("GET","other_withdraws_connector.php?others=1&boss_id="+boss_id+"&user_id="+user_id+ "&withdraw="+withdraw+ "&with_date="+with_date+"&amo="+amo,true);
xmlhttp.send();
}
}
...
WITHDRAW EXCESS/ REFUNDABLES </b> </div>     
...
<select  id="withdraw"  style="width:200px; border: 1px solid #006F37; height:35px" required> 
<option></option>
 
<option value="Excess">Excess</option>
<option value="Defaulters">Refundables</option>
